## Loja de Games :department_store::video_game:
### API desenvolvida para o gerenciamento de uma loja de games

![Badge Status](http://img.shields.io/static/v1?label=STATUS&message=Em%20Desenvolvimento&color=GREEN&style=for-the-badge)

<img src="https://user-images.githubusercontent.com/97403936/167022609-42d69dab-b7fb-479f-aa9d-ae4cff46b168.png" alt="Loja Games" width="400"/>

API desenvolvida para o gerenciamento de uma loja de games. A aplicação possui três tabelas: Produto, Categoria e Usuário.<br>
